...
from.addEventListener('submit', function (event) {
    ...
    var shareableURL = "".concat(Window.prototype.origin, "?username=").concat(encodeURIComponent(username));
...
window.addEventListener('DOMContentLoaded', function () {
    var urlPlarms = new URLSearchParams(window.location.search);
    var username = urlPlarms.get('username');
    if (username) {
